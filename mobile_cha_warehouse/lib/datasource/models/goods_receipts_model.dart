...
class GoodsReceiptsEntryModel extends GoodsReceiptEntry {
  GoodsReceiptsEntryModel(int itemId, int plannedQuantity, ItemModel item, List<GoodsReceiptEntryContainerModel> containers, dynamic note) : super(itemId, plannedQuantity, item, containers, note);
...
class GoodsReceiptsModel extends GoodsReceipt {
  GoodsReceiptsModel(String goodsReceiptId, String timestamp, bool confirmed,
      WarehouseEmployeeModel? approver, List<GoodsReceiptsEntryModel> entries)
