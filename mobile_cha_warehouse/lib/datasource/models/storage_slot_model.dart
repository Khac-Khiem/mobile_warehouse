...
class SliceModel extends Slice{
  SliceModel(int id, List<SliceLevelModel> levels, ItemModel product) : super(id, levels, product);

}
class CellModel extends Cell{
  CellModel(int row, int column, List<SliceModel> slices) : super(row, column, slices);
